...
with open('./data/news_extracts/R2000_201901_to_202109_allnews.json', 'w', encoding='utf-8') as f:
    json.dump(all_news, f, indent=4, ensure_ascii=False)

# save only unique articles
with open('./data/news_extracts/R2000_201901_to_202109_allnews.json', 'r', encoding='utf-8') as f:
...
for pos in range(0, len(corpus), chunksize):
    with open(f'./data/news_extracts/text_chunks/R2000_201901_to_202109_textchunk_{pos}.json', 'w', encoding='utf-8') as f:
